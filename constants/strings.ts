...
export const COMPLETE_REQUIRED_SECTIONS_TO_SUBMIT = 'Complete these required sections to submit:'
...
export const CONTRIBUTOR_INQUIRY_INTRO = 'We collaborate with talented engineers, designers, and product thinkers on client work. Tell us a bit about your background and share a sample of your work — our team will reach out about opportunities that fit.'
...
export const REQUIRED_STEPS_COMPLETE = 'Required steps complete'
...
export const SOFTWARE_SOLUTIONS_ENGINEERING = 'Software Solutions Engineering'
